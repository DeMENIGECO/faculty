...
👉 [Ultima versione (Installer per Windows)](https://github.com/DeMENIGECO/faculty/releases/download/1.0.3/installer.exe) \
👉 [Ultima Versione (codice sorgente .zip multipiattaforma)](https://github.com/DeMENIGECO/faculty/releases/download/1.0.3/faculty-editor-103.zip)
