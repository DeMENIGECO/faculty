...
👉 [Ultima versione (Installer per Windows)](https://github.com/DeMENIGECO/faculty/releases/download/1.0.4/installer.exe) \
👉 [Ultima Versione (codice sorgente .zip multipiattaforma)](https://github.com/DeMENIGECO/faculty/releases/download/1.0.4/faculty-editor-104.zip)


| Versione | Download | Supporto | Codice versione |
|:--------:|:--------:|:--------:|:---------------:|
| **1.0.4** | [⬇️ Installer (Windows)](https://github.com/DeMENIGECO/faculty/releases/download/1.0.4/installer.exe) [ ⬇️ Codice sorgente .zip](https://github.com/DeMENIGECO/faculty/releases/download/1.0.4/faculty-editor-104.zip)| ✅ Supportata | `xsh1` |
